...
class ResizePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Resize  $resize
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Resize $resize)
    {
        return true;
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Resize $resize)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Resize $resize)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Resize $resize)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Resize $resize)
    {
        if (!auth()->user()->role->permissions->where('slug','resize:delete' )->first()) {
            return Response::deny( 'У вас нет прав удалять');
        }
