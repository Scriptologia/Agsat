...
--
-- Хост: localhost
-- Время создания: Фев 15 2022 г., 16:53
...
--
-- База данных: `cyhvkzdh_smarttele`
--
...
CREATE TABLE `baskets` (
  ...
  `person` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`person`)),
...
CREATE TABLE `categories` (
  ...
  `tags_ru` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`tags_ru`)),
  `name_uk` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_uk` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tags_uk` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`tags_uk`)),
...
(25, 77, 'sputnikovie-resiveri-dvb-s2', 1, 'Спутниковые ресиверы (DVB - S2)', NULL, NULL, 'Категория 11', NULL, NULL, 0.00, NULL, '/storage/category/03-18-29-02-02-2022.png', 1, '2022-01-24 10:36:16', '2022-02-08 18:45:30'),
...
(28, 77, 'efirnie-resiveri-dvb-t2', 1, 'Эфирные ресиверы (DVB - T2)', NULL, NULL, 'Спутниковые антенны', 'описание', NULL, 0.00, NULL, '/storage/category/03-38-37-02-02-2022.png', 1, '2022-01-28 20:00:48', '2022-02-08 18:45:48'),
...
(77, NULL, 'resiveri', 1, 'Ресиверы', NULL, NULL, 'Ресиверы', NULL, NULL, 0.00, NULL, '/storage/category/03-18-29-02-02-2022.png', 1, '2022-02-08 17:02:40', '2022-02-08 18:00:52'),
...
CREATE TABLE `companies` (
  ...
  `text_uk` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `filters` (
  ...
  `name_ru` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_uk` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value_ru` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value_uk` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visible` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `skidka` float(11,2) NOT NULL DEFAULT 0.00,
  `dop_products` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`dop_products`)),
  `service_id` bigint(20) UNSIGNED DEFAULT NULL,
  `img` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`img`)),
  `visible` tinyint(1) NOT NULL DEFAULT 1,
  `type` enum('product','page') COLLATE utf8mb4_unicode_ci DEFAULT 'product',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `resizes` (
  ...
  `resizeMimeType` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
